      ...
      <section>
        <form className="relative mx-25 max-h-fit">
          <Input
            ...
            label=""
            inputType="text"
            placeholder="Busque por novos projetos..."
          />
          <Button
          ...
          />
          {/* Filters */}
          <div className="grid grid-rows-3 grid-cols-4 items-center mt-2 gap-x-4">
            <p>Público-alvo:</p>
            <p>Plataformas:</p>
            <p>Linguagem:</p>
            <p>Status:</p>
            ...
            <Select labels={{ test: "fish", test2: "test" }} name="test" />
            <Select labels={{ test: "fish", test2: "test" }} name="test2"/>
            <Select labels={{ python: "fish", test2: "test" }} name="test2"/>
            <Select labels={{ aberto: "OPEN", fechado: "CLOSED" }} name="test2" />

            <Input placeholder="test" label=""/>
            <Input placeholder="test2" label=""/>
          </div>
        </form>
      </section>
